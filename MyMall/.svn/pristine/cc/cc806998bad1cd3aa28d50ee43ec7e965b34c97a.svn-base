...
function promotionXu() {
    ...
    var e = null;
    null != localStorage.getItem(key_shoppingCart) && (e = localStorage.getItem(key_shoppingCart)), $(".big-gift").hide(), $.post("/my_xu/allpackage", {
        cart: e
    }, function(e) {
        "" != e && (e = JSON.parse(e), 1 == e.status && ($("#return_xu_promotion").html(e.output), $(".big-gift").show()))
    })
}
        ...
        return parseFloat(e) > parseInt(r) ? ($("div#errorMyXu").html("Số Xu bạn đổi vượt quá số Xu bạn có.").show(), !1) : ($("div#errorMyXu").html("").css({
            ...
            success: function(e) {
                if (0 == e) $("div#errorMyXu").html("Số xu bạn đổi đã vượt quá giá trị đơn hàng.").show();
                    ...
                    $("span#discoutMyXu").html("-"+a+ "đ"), $("b#tmp_total").html(number_format(n, 0, ".", ".") + "đ");
